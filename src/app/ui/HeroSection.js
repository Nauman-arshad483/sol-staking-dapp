    ...
    <section className="bg-black py-16 flex flex-grow justify-center items-center">
      <div className="container mx-auto grid grid-cols-2 gap-8 pb-64 pt-8">
        ...
        <div className="flex flex-col justify-center">
          ...
          <button className="w-32 text-xl font-bold bg-gradient-to-r from-orange-500 to-purple-500 text-white px-2 py-2 rounded-full mt-8 hover:bg-purple-500 hover:text-white">
            Deposit
          </button>
        </div>
        {/* Right column */}
